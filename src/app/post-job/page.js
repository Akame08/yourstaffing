              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-blue-500 focus:outline-none transition"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select 
                      name="category"
                      onChange={handleChange}
                      className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-blue-500 focus:outline-none transition appearance-none"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Salario (Anual Estimado)</label>
                    <input 
                      name="salary" 
                      onChange={handleChange}
                      type="text" 
                      placeholder="Ej: $50k - $80k" 
                      className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-blue-500 focus:outline-none transition"
                    />
                  </div>
                </div>
                ...
                <div>
                   <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Descripción de la Oferta</label>
                   <textarea 
                     rows="6"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div 
                  ...
                  className={`cursor-pointer p-6 rounded-xl border transition-all relative ${
                    plan === 'quarterly' 
                    ? 'bg-yellow-900/10 border-yellow-500 shadow-[0_0_20px_rgba(234,179,8,0.1)]' 
                    : 'bg-black border-white/10 hover:border-white/30'
                  }`}
                >
                  <div className="absolute -top-3 left-6 bg-yellow-500 text-black text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">
                    Recomendado
                  </div>
                  <div className="flex justify-between items-center mb-2">
                  ...
                  <p className="text-xs text-gray-300">Publicaciones <strong>ILIMITADAS</strong> por 90 días.</p>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-32">
              ...
              <div className="bg-[#0A0A0A] border border-white/10 rounded-xl p-6 shadow-2xl relative overflow-hidden group">
                 {/* Decoración plan */}
                 {plan === 'quarterly' && (
                   <div className="absolute top-0 right-0 bg-yellow-500 text-black text-[10px] font-bold px-3 py-1 rounded-bl-lg z-10">
                     DESTACADO
                   </div>
                 )}
                 ...
                 <div className="flex flex-wrap gap-2 mb-4">
                   ...
                   <Badge icon={<Briefcase className="w-3 h-3" />} text={formData.type} />
                 ...
                 <div className="pt-4 border-t border-white/5 flex justify-between items-center">
                   ...
                   <button className="px-4 py-1.5 bg-white text-black text-xs font-bold rounded hover:bg-gray-200">
                     APLICAR
                   </button>
                 </div>
              ...
              <div className="mt-8 bg-[#111] p-6 rounded-xl border border-white/5">
                ...
                <ul className="space-y-3 text-xs text-gray-400">
                  ...
                  <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> Alertas a candidatos (Email)</li>
